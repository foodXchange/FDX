...
export type { MatchV1Row as MatchV2Row };
export type { RunMatchV1Result as RunMatchV2Result };

export async function runMatchV2(requestId: string): Promise<RunMatchV1Result> {
  const { data, error } = await supabaseAdmin.rpc("match_v2", {
