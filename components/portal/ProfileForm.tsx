...
import { updateBuyerProfile } from "@/app/en/portal/profile/actions";
...
export default function ProfileForm({ email, name, company, phone }: Props) {
    ...
    <div className="space-y-8">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input name="company" defaultValue={company} className="dark-input" placeholder="Company name" />
        </div>
        <div>
