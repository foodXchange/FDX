...
export default function EnglishContactPage() {
  return (
    <main className="bg-white text-slate-800">
      ...
      {/* ── HERO ── */}
      <section className="px-6 py-16 text-center border-b border-slate-100">
        ...
        <div className="max-w-3xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border-2 border-green-200 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="font-bold text-slate-900">Prefer a quick conversation?</h2>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center justify-center w-full bg-green-500 hover:bg-green-600 text-white px-5 py-3 rounded-xl font-semibold text-sm transition shadow-sm"
            >
              Open WhatsApp →
            </a>
          </div>
          ...
          <div className="bg-white border-2 border-orange-200 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="font-bold text-slate-900">Prefer to write it out?</h2>
            </div>
            <p className="text-sm text-slate-600 leading-relaxed mb-5">
            ...
            <a
              href="#contact-form"
              className="inline-flex items-center justify-center w-full bg-orange-500 hover:bg-orange-600 text-white px-5 py-3 rounded-xl font-semibold text-sm transition shadow-sm"
            >
              Use the form below ↓
            </a>
          </div>
