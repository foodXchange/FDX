        ...
        <div className="max-w-3xl mx-auto space-y-10 pb-24">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8">
            ...
            <p className="text-slate-700 text-lg leading-relaxed">
              <strong className="text-slate-900">FOODZXCHANGE</strong><br />
              Tel Aviv, Israel<br />
              Company ID / VAT: 516970936<br />
              <a href="mailto:info@foodz-x.com" className="text-orange-600 hover:text-orange-700 transition font-medium">
                info@foodz-x.com
              </a>
            </p>
          </div>
